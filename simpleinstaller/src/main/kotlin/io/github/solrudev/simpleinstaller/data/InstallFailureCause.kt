...
sealed class InstallFailureCause(open val message: String?) {
	...
	data class Generic(override val message: String?) : InstallFailureCause(message) {
		override fun toString() = message ?: "INSTALL_FAILURE"
	}
	...
	data class Aborted(override val message: String?) : InstallFailureCause(message) {
		override fun toString() = message ?: "INSTALL_FAILURE_ABORTED"
	}
	...
	data class Blocked(
		...
		override fun toString() = (message ?: "INSTALL_FAILURE_BLOCKED") +
	...
	data class Conflict(
		...
		override fun toString() = (message ?: "INSTALL_FAILURE_CONFLICT") +
				if (otherPackageName != null) " | OTHER_PACKAGE_NAME = $otherPackageName" else ""
	}
	...
	data class Incompatible(override val message: String?) : InstallFailureCause(message) {
		override fun toString() = message ?: "INSTALL_FAILURE_INCOMPATIBLE"
	}
	...
	data class Invalid(override val message: String?) : InstallFailureCause(message) {
		override fun toString() = message ?: "INSTALL_FAILURE_INVALID"
	}
	...
	data class Storage(
		...
		override fun toString() = (message ?: "INSTALL_FAILURE_STORAGE") +
